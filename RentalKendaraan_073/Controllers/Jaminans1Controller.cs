...
{
    public class Jaminans1Controller : Controller
    {
        private readonly RentalKendaraanContext _context;

        public Jaminans1Controller(RentalKendaraanContext context)
        {
            _context = context;
        }
        ...
        // GET: Jaminans1/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: Jaminans1/Create
